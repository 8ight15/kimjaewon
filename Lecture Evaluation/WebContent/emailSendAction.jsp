...
<%
	...
	if(session.getAttribute("userID") != null) {//세션값이 유효한 상태일때

		userID = (String) session.getAttribute("userID");//세션값을 넣음
	...
	String from = "kjw54482@gmail.com";
...
%>						
    ...
    <footer class="bg-dark mt-4 p-5 text-center" style="color: #FFFFFF;">
      ...
      Copyright ⓒ 2019 김재원 All Rights Reserved.
